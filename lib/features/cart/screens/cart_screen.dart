                ...
                child: ExpandableBottomSheet(
                  ...
                  persistentHeader: isDesktop ? const SizedBox() : InkWell(
                    ...
                    child: Container(
                      ...
                      child: Container(
                        height: 17, // Maintain a consistent height
                        decoration: BoxDecoration(
                          color: Theme.of(context).disabledColor.withOpacity(0.3), // Lighter shade for subtlety
                        ...
                        child: Center( // Center the icon
                          child: Icon(
                            ...
                            size: 20, // Keep it smaller for a more subtle look
                          ),
                        ),
                      ),
                    ),
                                              ...
                                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: TextButton.icon(
                                                    ...
                                                    icon: Icon(Icons.fastfood_outlined, color: Theme.of(context).primaryColor),
                                                    label: Text(
                        ...
                        children: [
                          Text(
                            ...
                            style: robotoBold.copyWith(
                              ...
                              color: Colors.black87, // Changed to a darker color for elegance
                            ),
                          ),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                'item_price'.tr,
                                style: robotoRegular.copyWith(color: Colors.black54), // Dark gray for better contrast
                              ),
                              PriceConverter.convertAnimationPrice(
                                cartController.itemPrice,
                                textStyle: robotoRegular.copyWith(color: Colors.black87), // Darker for emphasis
                              ),
                            ],
                          ),
                          ...
                          // Variation Price Row (if applicable)
                          if (cartController.variationPrice > 0)
                            Row(
                              ...
                              children: [
                                Text(
                                  'variations'.tr,
                                  style: robotoRegular.copyWith(color: Colors.black54),
                                ),
                                Text(
                            ...
                            children: [
                              ...
                              restaurantController.restaurant != null
                                ...
                                PriceConverter.convertAnimationPrice(
                                  ...
                                  textStyle: robotoRegular.copyWith(color: Colors.red),
                                ),
                              ])
                                  : Text(
                                'calculating'.tr,
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                PriceConverter.convertAnimationPrice(
                                  ...
                                  textStyle: robotoRegular.copyWith(color: Colors.green),
                                ),
                              ]),
                            ],
                          ),
