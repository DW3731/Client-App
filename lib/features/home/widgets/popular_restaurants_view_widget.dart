...
class PopularRestaurantsViewWidget extends StatelessWidget {
               ...
               restaurantList != null ? SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Retrieve the distance of the restaurant
                      double distance = restController.getRestaurantDistance(LatLng(
                          double.parse(restaurantList[index].latitude!),
                          double.parse(restaurantList[index].longitude!)
                      ));
                        ...
                        child: Container(
                          ...
                          child: CustomInkWellWidget(
                            ...
                            child: Stack(
                              ...
                              children: [
                                Container(
                                  height: 120, width: ResponsiveHelper.isDesktop(context) ? 253 : MediaQuery.of(context).size.width * 0.7,
                                ...
                                Positioned(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      restaurantList[index].freeDelivery!
                                          ? Padding(
  ...
  double calculateDeliveryCharge(double distance) {
    const double baseCharge = 2.5;  // Base delivery charge
    const double additionalChargePerKm = 0.5; // Charge per km above 5km
    if (distance <= 5) {
      return baseCharge;
    } else {
      return baseCharge ;
