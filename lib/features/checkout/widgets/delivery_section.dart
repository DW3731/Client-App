      ...
      isGuestLoggedIn  ? GuestDeliveryAddress(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: Dimensions.paddingSizeSmall), // Spacing between title and dropdown
            ...
            const SizedBox(height: Dimensions.paddingSizeSmall), // Spacing before the address card
            ...
            Container(
              ...
              child: AddressCardWidget(
                address: (checkoutController.address.length - 1) >= checkoutController.addressIndex
            ...
            const SizedBox(height: Dimensions.paddingSizeExtraLarge), // Additional spacing before text fields
            ...
            Row(
              children: [
                ...
                if (ResponsiveHelper.isDesktop(context)) const SizedBox(width: Dimensions.paddingSizeSmall), // Spacing for desktop layout
            ...
            const SizedBox(height: Dimensions.paddingSizeExtraSmall), // Final spacing
          ],
        )
